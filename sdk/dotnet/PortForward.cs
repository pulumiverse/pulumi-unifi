...
{
    /// <summary>
    /// `unifi.PortForward` manages a port forwarding rule on the gateway.
    /// </summary>
    [UnifiResourceType("unifi:index/portForward:PortForward")]
    public partial class PortForward : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public PortForward(string name, PortForwardArgs? args = null, CustomResourceOptions? options = null)
            : base("unifi:index/portForward:PortForward", name, args ?? new PortForwardArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PortForward(string name, Input<string> id, PortForwardState? state = null, CustomResourceOptions? options = null)
            : base("unifi:index/portForward:PortForward", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PortForwardArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The destination port for the forwarding.
        /// </summary>
    ...
    public sealed class PortForwardState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The destination port for the forwarding.
        /// </summary>
