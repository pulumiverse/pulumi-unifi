...
namespace Pulumiverse.Unifi
{
    ...
    public partial class PortProfile : Pulumi.CustomResource
    {
        ...
        public PortProfile(string name, PortProfileArgs? args = null, CustomResourceOptions? options = null)
            : base("unifi:index/portProfile:PortProfile", name, args ?? new PortProfileArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PortProfile(string name, Input<string> id, PortProfileState? state = null, CustomResourceOptions? options = null)
            : base("unifi:index/portProfile:PortProfile", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class PortProfileArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable link auto negotiation for the port profile. When set to `true` this overrides `speed`. Defaults to `true`.
        /// </summary>
    ...
    public sealed class PortProfileState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable link auto negotiation for the port profile. When set to `true` this overrides `speed`. Defaults to `true`.
        /// </summary>
