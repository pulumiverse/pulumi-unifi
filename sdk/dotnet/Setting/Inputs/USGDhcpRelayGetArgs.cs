...
namespace Pulumiverse.Unifi.Setting.Inputs
{
    ...
    public sealed class USGDhcpRelayGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("hopCount")]
        public Input<int>? HopCount { get; set; }
        ...
        public USGDhcpRelayGetArgs()
        {
        }
        public static new USGDhcpRelayGetArgs Empty => new USGDhcpRelayGetArgs();
    }
}
