...
namespace Pulumiverse.Unifi.Setting.Inputs
{
    ...
    public sealed class IpsSuppressionAlertArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("trackings")]
        private InputList<Inputs.IpsSuppressionAlertTrackingArgs>? _trackings;
        ...
        /// </summary>
        public InputList<Inputs.IpsSuppressionAlertTrackingArgs> Trackings
        {
            get => _trackings ?? (_trackings = new InputList<Inputs.IpsSuppressionAlertTrackingArgs>());
        ...
        public IpsSuppressionAlertArgs()
        {
        }
        public static new IpsSuppressionAlertArgs Empty => new IpsSuppressionAlertArgs();
    }
}
