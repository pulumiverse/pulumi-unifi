...
public final class RadiusProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final RadiusProfileArgs Empty = new RadiusProfileArgs();
    ...
    private RadiusProfileArgs() {}

    private RadiusProfileArgs(RadiusProfileArgs $) {
    ...
    public static Builder builder(RadiusProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RadiusProfileArgs();
        }

        public Builder(RadiusProfileArgs defaults) {
            $ = new RadiusProfileArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RadiusProfileArgs build() {
            return $;
        }
    }
