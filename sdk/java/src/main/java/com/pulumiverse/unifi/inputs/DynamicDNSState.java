...
public final class DynamicDNSState extends com.pulumi.resources.ResourceArgs {

    public static final DynamicDNSState Empty = new DynamicDNSState();
    ...
    private DynamicDNSState() {}

    private DynamicDNSState(DynamicDNSState $) {
    ...
    public static Builder builder(DynamicDNSState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DynamicDNSState defaults) {
            $ = new DynamicDNSState(Objects.requireNonNull(defaults));
        }
