...
public final class WlanArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(WlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WlanArgs defaults) {
            $ = new WlanArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder security(Output<String> security) {
            $.security = security;
            return this;
        }
