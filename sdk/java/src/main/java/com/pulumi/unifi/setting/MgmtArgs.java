...
public final class MgmtArgs extends com.pulumi.resources.ResourceArgs {

    public static final MgmtArgs Empty = new MgmtArgs();
    ...
    public static Builder builder(MgmtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MgmtArgs defaults) {
            $ = new MgmtArgs(Objects.requireNonNull(defaults));
        }
