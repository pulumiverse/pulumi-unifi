...
public final class USGArgs extends com.pulumi.resources.ResourceArgs {

    public static final USGArgs Empty = new USGArgs();
    ...
    public static Builder builder(USGArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(USGArgs defaults) {
            $ = new USGArgs(Objects.requireNonNull(defaults));
        }
